...
data class GameCache(@PrimaryKey val id: Int,
                     val name: String,
                     val url: String,
                     ...
                     @Embedded val timeToBeat: TimeToBeatCache?,
                     @Embedded val cover: CoverCache?)

data class TimeToBeatCache(@ColumnInfo(name = "beat_hastly") val hastly: Int?,
                           @ColumnInfo(name = "beat_normally") val normally: Int?,
                           @ColumnInfo(name = "beat_completely") val completely: Int?)

data class CoverCache(@ColumnInfo(name = "cover_url") val url: String,
                     @ColumnInfo(name = "cover_width") val width: Int?,
                     @ColumnInfo(name = "cover_height") val height: Int?)

//@Entity(tableName = "time_to_beat",
//        foreignKeys = arrayOf(ForeignKey(entity = GameCache::class,
