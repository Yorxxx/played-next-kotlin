 ...
 * and a list of [games]
 * For example, a Playlist with [name] "Backlog", could contain a list of games not played
 */
data class Playlist(val name: String, val description: String?, val color: Int, val games: List<Game>,
