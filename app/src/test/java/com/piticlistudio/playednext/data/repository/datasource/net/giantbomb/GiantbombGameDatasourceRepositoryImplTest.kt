...
/**
 * Test cases for [GiantbombGameDatasourceRepositoryImpl]
    ...
    inner class GameRemoteImplInstance {
        ...
        inner class Search {
            ...
            fun setup() {
                ...
                whenever(service.searchGames(anyString(), anyString(), anyString(), anyString(), anyString(), anyInt(), anyInt())).thenReturn(flowable)
